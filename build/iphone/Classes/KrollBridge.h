...
@interface CuidadoInfantilObject : KrollCoverageObject {
#else
@interface CuidadoInfantilObject : KrollObject {
#endif
@private
...
extern NSString * CuidadoInfantil$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CuidadoInfantilObject *_cuidadoinfantil;
	BOOL shutdown;
