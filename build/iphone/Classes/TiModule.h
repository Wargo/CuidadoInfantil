...
/**
 The base class for all CuidadoInfantil modules
 */
...
/**
 CuidadoInfantil Platform calls this method on startup.
 */
-(void)startup;

/**
 CuidadoInfantil Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 CuidadoInfantil Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 CuidadoInfantil Platform calls this method on resume.
 @param sender The sender of the event.
 */
