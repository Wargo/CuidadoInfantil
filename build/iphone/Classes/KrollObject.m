 ...
 * Copyright (c) 2009-2011 by CuidadoInfantil, Inc. All Rights Reserved.
...
//@interface CuidadoInfantilObject : NSObject
//@end

@interface CuidadoInfantilObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CuidadoInfantilObject class]])
		{
			for (NSString *key in [[(CuidadoInfantilObject*)o modules] allKeys])
			{
