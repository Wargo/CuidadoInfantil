...
//Rare exceptions to indicate a bug in the _cuidadoinfantil code (Eg, function that a subclass should have implemented)
...
/**
 The base class for CuidadoInfantil proxies.
 */
