...
// in simulator we redefine to format for CuidadoInfantil Developer console
...
{\
	NSString * exceptionName = [@"org.cuidadoinfantil." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cuidadoinfantil";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICuidadoInfantilNativeItemNone = -1, 
	UICuidadoInfantilNativeItemSpinner = -2,
	UICuidadoInfantilNativeItemProgressBar = -3,
	
	UICuidadoInfantilNativeItemSlider = -4,
	UICuidadoInfantilNativeItemSwitch = -5,
	UICuidadoInfantilNativeItemMultiButton = -6,
	UICuidadoInfantilNativeItemSegmented = -7,
	
	UICuidadoInfantilNativeItemTextView = -8,
	UICuidadoInfantilNativeItemTextField = -9,
	UICuidadoInfantilNativeItemSearchBar = -10,
	
	UICuidadoInfantilNativeItemPicker = -11,
	UICuidadoInfantilNativeItemDatePicker = -12,
	
	UICuidadoInfantilNativeItemInfoLight = -13,
	UICuidadoInfantilNativeItemInfoDark = -14,
	
	UICuidadoInfantilNativeItemDisclosure = -15,
	
	UICuidadoInfantilNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CuidadoInfantil instances of
